...
local map_buttons = function(binds)
  return map(awful.button, binds)
 end

local map_keys = function(binds)
  return map(awful.key, binds)
 end

-- global shortkeys
config.keys.global = swful.unit.table.join(
  keydoc.group("Focus"),
